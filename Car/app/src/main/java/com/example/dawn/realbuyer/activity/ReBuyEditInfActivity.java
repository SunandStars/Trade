 ...
 */
public class ReBuyEditInfActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.realbuyer_manage_edit_inf);
...
//                                  editorEidt.putString("point",);//暂时还没有经销商评分的功能
                            ...
                            {
                                Toast.makeText(ReBuyEditInfActivity.this,"请将信息填写完整",Toast.LENGTH_SHORT).show();
                            }
...
//                Toast.makeText(getApplicationContext(),"验证码是："+checktemp,Toast.LENGTH_LONG).show();
    ...
    private JSONObject query(String manageStep,String username,String company,String legalperson,
                             String address,String post,String zhifubao,String wechat,String qq,String email,
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Toast.makeText( ReBuyEditInfActivity.this, "关闭对话框", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
...
// 这个路径，在手机内存下创建一个pictures的文件夹，把图片存在其中。
            ...
            if (null !=  ReBuyEditInfActivity.this) {
...
// 保存图片
                try {
                    ...
                    Log.i("1", "flag=" + flag);
                    if (flag) {
                        Toast.makeText (ReBuyEditInfActivity.this,
...
// 展示图片，点击放大
                        ...
                        Toast.makeText( ReBuyEditInfActivity.this, "图片保存失败!", Toast.LENGTH_SHORT).show();
                    }
            ...
            if (requestCode == 2 && data != null
                ...
                try {
                    ...
                    Cursor c = ReBuyEditInfActivity.this.getContentResolver().query(
...
//                });
    ...
    private void showImageDialog(Bitmap b, final String orderNo,
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( ReBuyEditInfActivity.this);


        builder.setTitle("请上传包含车牌的清晰照片");
        View imgEntryView = View.inflate( ReBuyEditInfActivity.this,
                R.layout.buy_writeorder_photo_magnify, null); // 加载自定义的布局文件
        ImageView img = (ImageView) imgEntryView.findViewById(R.id.large_image);
        if (b != null) {
            Display display =  ReBuyEditInfActivity.this.getWindowManager()
                    .getDefaultDisplay();
            ...
            Toast.makeText( ReBuyEditInfActivity.this, "获取照片失败", Toast.LENGTH_SHORT).show();
...
//    }
     ...
     * @param context
     */
    public boolean isNetworkConnected( ReBuyEditInfActivity context) {
        if (context == null) {
            return false;
        }
