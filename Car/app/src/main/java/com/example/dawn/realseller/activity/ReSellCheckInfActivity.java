...
import com.example.dawn.realbuyer.activity.ReBuyEditInfActivity;


/**
 * Created by wanxiao on 2015/11/9.
 */
public class ReSellCheckInfActivity extends Activity
{
    SharedPreferences preferencessellcheckinf;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.realseller_manage_check_inf);
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ReSellCheckInfActivity.this,ReBuyEditInfActivity.class);
        ...
        preferencessellcheckinf=this.getSharedPreferences("userinf", MODE_PRIVATE);

        //读取 SharedPreferences中的数据
        usertype.setText(preferencessellcheckinf.getString("usertype", null));
        username.setText(preferencessellcheckinf.getString("username", null));
        phone.setText(preferencessellcheckinf.getString("phoneNumber", null));
        company.setText(preferencessellcheckinf.getString("company", null));
        legalperson.setText(preferencessellcheckinf.getString("legalpersonname", null));
        address.setText(preferencessellcheckinf.getString("address", null));
        post.setText(preferencessellcheckinf.getString("postnum", null));
        zhifubao.setText(preferencessellcheckinf.getString("alipaynum", null));
        wechat.setText(preferencessellcheckinf.getString("weixinnum", null));
        qq.setText(preferencessellcheckinf.getString("qq", null));
        email.setText(preferencessellcheckinf.getString("email", null));
        String pic1=preferencessellcheckinf.getString("lisencepic",null);
        String pic2=preferencessellcheckinf.getString("companypic", null);
